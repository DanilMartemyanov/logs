...
public class FactoryLogTest {
    ...
    void buildLogDto(){
        ...
        LogRecord logRecord = factoryLog.createLogDto(remoteAddress);
        Assertions.assertEquals("93.180.71.3", logRecord.remoteAddress());
        Assertions.assertEquals("/downloads/product_1", logRecord.pathResources());
